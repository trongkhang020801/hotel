...
export default class AddTutorial extends Component {
  ...
  saveCustomer() {
    ...
    if (data.idCustomer === "" || data.idDec==="" || data.nameCustomer === "" || data.scoreLevel==="" || data.usedScoreLevel === "" || data.genderCustomer===""
    || data.dateOfBirth === "" || data.phoneNumberCustomer==="" || data.mailCustomer === "" || data.addressCustomer==="")
        {
          window.confirm("Enter the all data war customer!")
        }
    else
    {
    CustomerDataService.create(data)
      .then(response => {
        ...
        window.confirm("Create user succssfuly!");
